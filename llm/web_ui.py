        ...
        with gr.Column(scale=1):
            help_page = gr.Textbox(
                ...
                value=(
                    ...
                    "* Ранг (место в топе по количеству проблем)\n"
                    "* Муниципалитет\n"
                    "* Кол-во проблем\n"
                    "* Темы (частота) (самые частые темы проблем)\n"
                    "* Темы (острота) (самые острые темы и показатель "
                    "их остроты от 1 до 5 где 5 - чрезвычайные ситуации)\n"
                    "* Отчёт AI (краткая выжимка самых острых проблем)"
                )
            )
